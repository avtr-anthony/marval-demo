...
export function PostHeroSections({
    ...
    return (
        <>
            <Container
                as="section"
                className="pb-[calc(var(--space-section-y)*1.15)] "
            >
                ...
                <Reveal className="space-y-8">
                    <div className="grid grid-cols-2 gap-4 text-center text-xs uppercase tracking-[0.16em] text-ink-dim md:grid-cols-5">
                        {trustStrip.slice(0, 5).map(item => (
                            <div
                                key={item}
                                className="rounded-card border border-stroke-soft bg-transparent px-3 py-4 text-ink"
                            >
                                {item}
                            </div>
                        ))}
            ...
            >
                <Reveal className="bg-transparent p-8 text-center sm:p-12">
                    ...
                    <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-ink-dim">
                        Tratamiento de información con estándares estrictos para
                        operaciones legales y fiscales.
                    </p>
                    <div className="mx-auto mt-10 grid max-w-3xl gap-5 sm:grid-cols-2 lg:grid-cols-4">
                        {[
                            ...
                            <div
                                key={item}
                                className="rounded-card border border-stroke-soft bg-white/[0.03] p-4"
                            >
            ...
            {/* <Container
                as="section"
                className="space-y-36 pb-[calc(var(--space-section-y)*1.35)]"
            >
                {rows.map((row, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <h3 className="font-serif text-5xl text-ink">
                                    {row.title}
                                </h3>
            ...
            <Container
                as="section"
                className="pb-[calc(var(--space-section-y)*1.1)]"
            >
                    ...
                    <div className="grid gap-0 lg:grid-cols-[0.9fr_1.6fr]">
                        <div className="relative p-10">
                            ...
                            <div className="relative">
                                ...
                                <h3 className="mt-4 font-serif text-6xl leading-none text-ink">
                                    Empieza gratis
                                </h3>
                                <p className="mt-6 max-w-sm text-2xl leading-relaxed text-ink-dim">
                                    Probá consultas en segundos y validá
                                    resultados con tu equipo.
                                </p>
                                <ActionLink
                                    href={siteConfig.routes.chat}
                                    className="mt-8 bg-white px-6 py-3 text-slate-900 hover:bg-slate-100"
                                >
                                    Probar ahora
                                </ActionLink>
                            </div>
            ...
            <Container
                as="section"
                className="pb-[calc(var(--space-section-y)*1.15)] pt-16"
            >
                <div className="mx-auto max-w-2xl">
                    ...
                    <h2 className="mt-5 text-center font-serif text-3xl text-ink sm:text-4xl">
